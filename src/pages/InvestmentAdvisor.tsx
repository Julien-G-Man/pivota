...
import { ChevronRight, Send, TrendingUp, BarChart3, LineChart, PieChart, MessageCircle, HelpCircle } from 'lucide-react';
...
const InvestmentAdvisor = () => {
  ...
  const handleSendMessage = () => {
    ...
    toast({
      title: "Mona AI",
      description: "I'm analyzing your investment profile and will provide personalized advice shortly.",
    });
          ...
          <TabsContent value="advisor" className="space-y-4">
            <Card className="overflow-hidden">
              ...
              <CardContent className="p-0">
                <div className="h-64 overflow-y-auto p-4 bg-gradient-to-b from-white to-gray-50">
                  <div className="flex flex-col space-y-4">
                    <div className="bg-blue-100 p-3 rounded-lg max-w-[80%] self-start">
                      <p className="text-sm">Hello! I'm Mona, your AI financial advisor. Based on your spending habits and market trends, I can provide personalized investment advice.</p>
                    </div>
                    
                    <div className="bg-blue-100 p-3 rounded-lg max-w-[80%] self-start">
                      <p className="text-sm">How can I help you with your investments today?</p>
                    </div>
                    
                    <div className="bg-blue-600 text-white p-3 rounded-lg max-w-[80%] self-end">
                      <p className="text-sm">What investments should I make with my savings?</p>
                    </div>
                    
                    <div className="bg-blue-100 p-3 rounded-lg max-w-[80%] self-start">
                      <p className="text-sm">Based on your spending patterns, you have potential to save an additional 115,000 FCFA monthly. I recommend allocating 60% to low-risk bonds, 30% to mutual funds, and 10% to emerging tech stocks for growth potential.</p>
                    </div>
                  </div>
                </div>
